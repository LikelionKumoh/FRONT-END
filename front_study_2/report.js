const numbers = [
  1, 1, 1, 2, 2, 3, 3, 3, 3, 9, 3, 4, 4, 5, 5, 5, 6, 9, 6, 7, 7, 7, 8, 8, 9, 9,
];
const newNumbers = [];
...
const bookCafe_obj = [
  { name: "아메리카노", price: 2200 },
  { name: "바닐라라떼", price: 2600 },
  { name: "카라멜모카", price: 2700 },
  { name: "카페모카", price: 2700 },
...
bookCafe_arr.forEach((menu) => newBookCafe_arr.push(menu));
console.log(newBookCafe_arr);
const newBookCafe_obj = [];
bookCafe_obj.forEach((menu) => newBookCafe_obj.push(menu));
console.log(newBookCafe_obj);
...
console.log(myIncludes([1, 2, 3, 4], 3));
//----------------------------------------------------------------------

// 과제 6번
// findIndex 함수로 _obj의 가격이 2000인 메뉴 찾고 index를 이용하여 메뉴 이름 출력하기 !
console.log(
  bookCafe_obj[bookCafe_obj.findIndex((menu) => menu.price === 2000)].name
);
//----------------------------------------------------------------------
...
const filteredMenu = bookCafe_obj.filter((menu) => menu.price === 2700);
...
const sortedByPrice = [...bookCafe_obj];
...
const sortedByName = [...bookCafe_obj];
