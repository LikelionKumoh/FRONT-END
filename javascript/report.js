...
// 10개 이상(파이썬(Django), 자바, 자바스크립트(Node. js), 루비(레일즈), PHP)
// 3번 문제 : Frontend에서 얼마나 많은 프로그래밍 언어들을 사용할까요 ?
// HTML, CSS and JS(주로 3개를 이용하나 이외에도 react와 같은 것들이 있음)
...
// type을 확인하고 싶으면 ? typeof()
// console로 찍고 싶으면 ? console.log()
// 변수를 선언하고 싶으면 ? const, let, var(오류가 많아서 잘 사용 x)
// 세가지를 잘 생각하며 실습해보세요 ! 
